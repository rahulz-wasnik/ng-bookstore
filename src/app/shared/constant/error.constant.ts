...
export const BookError = {
    getOptionsFail: 'An error occured while loading categories. Please try again later.',
    ...
    deleteBookFail: 'An error occured while deleting this book. Please try again later.'
};
